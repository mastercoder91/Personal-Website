...
export const SocialStamps: React.FC = () => {
  ...
  return (
    <section id="stamps" className="py-16 md:py-24 border-b-4 border-[#141414] bg-[#F5F2ED] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        <p className="mt-4 text-stone-700 font-sans max-w-2xl text-sm sm:text-base leading-relaxed">
          Each social outpost rendered as a commemorative postage stamp. Hover to wobble, click to inspect philatelic details, copy handle, or launch direct dispatch.
        </p>
          ...
          {SOCIAL_STAMPS.map((stamp, idx) => {
            ...
            return (
              ...
              >
                ...
                <div 
                  className="p-5 rounded-none border-2 border-[#141414] shadow-[6px_6px_0px_#141414] transition-all relative overflow-hidden flex flex-col justify-between min-h-[300px]"
                  style={{
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute top-2 right-2 border-2 border-black/35 rounded-full w-16 h-16 flex flex-col items-center justify-center text-black/35 -rotate-12 pointer-events-none select-none">
                      <span className="text-[6px] font-mono-retro font-bold leading-tight">{stamp.postmarkCity}</span>
                      <span className="text-[6px] font-mono-retro font-bold leading-tight">{stamp.postmarkDate}</span>
                      <div className="w-10 h-[1px] bg-black/35 my-0.5" />
                      <span className="text-[5px] font-mono-retro uppercase">PASSED</span>
                    </div>
                    ...
                    <p className="font-mono-retro text-xs text-stone-600 font-bold mt-0.5">
                      {stamp.handle}
                    </p>
                  </div>
          ...
          {selectedStamp && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-[#141414]/80 backdrop-blur-sm">
              <motion.div
                ...
                className="relative w-full max-w-lg bg-[#FFFFFF] border-4 border-[#141414] p-6 sm:p-8 shadow-[12px_12px_0px_#141414] bg-halftone"
              >
                {/* Close Button */}
                <button
                  onClick={closeModal}
                  data-cursor="CLOSE"
                  className="absolute top-4 right-4 p-2 bg-[#141414] text-[#F5F2ED] hover:bg-[#D95D39] transition-colors"
                >
                  <X className="w-4 h-4" />
                </button>

                <div className="flex items-center space-x-2 text-xs font-mono-retro font-bold text-[#D95D39] mb-2">
                  <Award className="w-4 h-4" />
                  <span>PHILATELIC ARCHIVE EXAMINATION</span>
                </div>

                <div className="flex items-start space-x-4 border-b-2 border-[#141414] pb-4">
                  <div 
                    className="w-16 h-16 flex items-center justify-center text-[#F5F2ED] border-2 border-[#141414] shadow-md shrink-0"
                    style={{ backgroundColor: selectedStamp.color }}
                  >
                    {getIcon(selectedStamp.iconName)}
                  </div>
                  <div>
                    <h3 className="font-rozha text-3xl font-black text-[#141414] leading-none">
                      {selectedStamp.name}
                    </h3>
                    <p className="font-mono-retro text-sm font-bold text-stone-600 mt-1">
                      {selectedStamp.handle}
                    </p>
                    <span className="inline-block mt-1 text-[10px] font-mono-retro font-bold px-2 py-0.5 bg-[#E6A92A] text-[#141414] border border-[#141414]">
                ...
                {/* Philatelic Specs */}
                <div className="mt-4 space-y-3 font-mono-retro text-xs text-stone-800">
                  <p className="text-sm font-sans text-stone-700 leading-relaxed">
                    {selectedStamp.description}
                  </p>

                  <div className="p-3 bg-[#F5F2ED] border border-stone-300 space-y-1">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="text-[#0E3D3C] font-bold truncate max-w-[200px]">{selectedStamp.url}</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-6 flex items-center space-x-3">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 py-3 bg-[#D95D39] text-[#F5F2ED] font-mono-retro font-bold text-xs uppercase tracking-wider border-2 border-[#141414] shadow-[4px_4px_0px_#141414] hover:bg-[#C04C2A] text-center flex items-center justify-center space-x-2"
                  >
                  ...
                  <button
                    ...
                    className="px-4 py-3 bg-[#FFFFFF] text-[#141414] font-mono-retro font-bold text-xs uppercase tracking-wider border-2 border-[#141414] shadow-[4px_4px_0px_#141414] hover:bg-[#F5F2ED] flex items-center space-x-1.5"
                  >
